...
var initEvent = function() {
    $(".btn-cancel").click(function() {
        window.location.href="http://closewindow?appName=com.trendmicro.DrUnzip";
    });

    $(".btn-open").click(function() {
        openApp('com.trendmicro.DrUnzip', 'macappstore://itunes.apple.com/app/id1127253508?mt=12&at=1001ldFh&ct=Safety.DrUnzip.V1000');
    });
}
